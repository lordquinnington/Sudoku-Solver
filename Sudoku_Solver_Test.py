...
##            if finished == True:
##                return gridArray[i]
##            if gridArray[i] == previousGridArray:
##                #moreGridArrays.append(gridArray)#
##                print("guessing")#
##                return guess(gridArray[i],squareSize)
##                break
...
def guess(possibleGridsArray,squareSize,leastPossibleNuma):
#for i in range(len(possibleGridsArray)):
    #print("guessing")
    finished, counter = checkGridIsCompleted(possibleGridsArray[0],squareSize)
    while not finished:
        previousGridArray = copy.deepcopy(possibleGridsArray[0])
        gridArray = solve(possibleGridsArray[0],squareSize)
